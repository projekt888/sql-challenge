...
SELECT Dept_Manager.dept_no, Departments.dept_name, Dept_Manager.emp_no FROM Departments INNER JOIN Dept_Manager ON Dept_Manager.dept_no=Departments.dept_no;
